...
import Game.World.InWorldAreas.TownArea; // ADDED FOR TOWN SET 1
...
public class InWorldState extends State{
	...
	public static BaseArea townArea; // ADDED FOR TOWN SET 1
	...
	public InWorldState(Handler handler) {
		...
		townArea = new TownArea(handler, entityManager); // ADDED FOR TOWN SET 1
